...
All hadronic events fall on the line joining $f_em=0$ to $f_em=1$, as illustrated in Fig. \ref{fig:groom}.  The projections 
...
\begin{figure}
 \includegraphics[scale=0.35]{Calorimeter/DualReadout/hcalor.eps}
 \label{fig:hcalor}
