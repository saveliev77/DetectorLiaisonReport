...
\begin{figure}
    ...
    \caption{Left: A GaAs pad sensor developed for BeamCal. Right:CVD diamond sensors}
...
\begin{figure}
    ...
    \caption{Left: LumiCal Sensors. Right:LumiCal ASIC}
    \label{fig:Calorimeter:FCAL:LumiCal}
\end{figure}
This results in a semi-insulating GaAs material with a resistivity of about \SI{1e7}{\ohm \meter}.
The sensors are \SI{0.5}{mm} thick with pads of a few \si{\square\milli\meter} area. The operation voltage is about \SI{100}{V} with
